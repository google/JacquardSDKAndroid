...
import com.google.android.jacquard.sample.SampleTypeAdapterFactory;
...
public class RecipeManagerTest {
    ...
    private Gson getGson() {
        if (gson == null) {
            gson = new GsonBuilder().registerTypeAdapterFactory(SampleTypeAdapterFactory.create()).create();
        }
        return gson;
    }

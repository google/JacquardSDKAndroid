...
/**
 * Class representing a Recipe(Gesture-Ability pair).
 */
@AutoValue
public abstract class Recipe implements Serializable {

    public static Recipe of(String abilityId, int gestureId) {
        return new AutoValue_Recipe(abilityId, gestureId);
    }

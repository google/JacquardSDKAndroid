...
/**
 * Viewmodel class for {@link ImuSamplesListFragment}.
 */
public class ImuSamplesListViewModel extends ViewModel {

  private final NavController navController;

  public ImuSamplesListViewModel(NavController navController) {
   ...
   */
  public Signal<ImuSessionData> parse(@NonNull final String path) {

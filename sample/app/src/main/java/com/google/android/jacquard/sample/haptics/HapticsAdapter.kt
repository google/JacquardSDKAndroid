...
class HapticsAdapter(private val itemClickListener: ItemClickListener) : RecyclerView.Adapter<HapticsAdapter.HapticsViewHolder>() {
    ...
    /** A layout place holder for haptic item.  */
     class HapticsViewHolder(private val view: View, private val itemClickListener: ItemClickListener)

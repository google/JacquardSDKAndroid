...
class SplashViewModel(private val preferences: Preferences, private val navController: NavController) : ViewModel() {

    fun navigateToNextScreen() {
        val navDirections: NavDirections = if (preferences.getKnownTags().isEmpty()) {

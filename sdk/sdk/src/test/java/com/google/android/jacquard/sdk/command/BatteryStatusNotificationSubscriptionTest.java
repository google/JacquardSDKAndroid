...
/**
 * Unit test for {@link BatteryStatusNotificationSubscription} class.
 */
@RunWith(AndroidJUnit4.class)
@Config(sdk = {VERSION_CODES.P}, manifest = Config.NONE)
public final class BatteryStatusNotificationSubscriptionTest {
    private BatteryStatusNotificationSubscription notificationSubscription;

    @Before
    public void setUp() {
        DataProvider.create(new HashMap<>());
        notificationSubscription = new BatteryStatusNotificationSubscription();
    }
        ...
        notificationSubscription.extract(
            JacquardProtocol.Notification.newBuilder()
                ...
                .setExtension(
                    ...
                    JacquardProtocol.BatteryStatusNotification.getDefaultInstance())
                .build()
                .toByteArray());
        // Assert

...
public class DeviceInfoCommandTest {
  ...
  public void parseResponse_throwsIllegalStateException() {
    ...
    // Act
    Result<DeviceInfo> deviceInfoResponse = command.parseResponse(response);
    // Assert
    assertThat(deviceInfoResponse.failure()).isInstanceOf(IllegalStateException.class);
  }
  ...
  public void parseResponse_successResponse() {
    ...
    Response response = Response.newBuilder()
        ...
        .build();
    // Act
    Result<DeviceInfo> responseResult = command.parseResponse(response);

...
/**
 * Unit test for {@link GestureNotificationSubscription} class.
 */
@RunWith(AndroidJUnit4.class)
@Config(sdk = {VERSION_CODES.P}, manifest = Config.NONE)
public final class GestureNotificationSubscriptionTest {
    private GestureNotificationSubscription notificationSubscription;

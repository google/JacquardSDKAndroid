...
public final class DfuWriteCommandTest {
  ...
  public void parseResponse_errorUnsupported() {
    ...
    // Act
    Result<DFUWriteResponse> dfuResponse = dfuWriteCommand.responseErrorCheck(response.toByteArray());
    // Assert
    assertThat(
            dfuResponse
                .failure()
  ...
  public void parseResponse_successResponse() {
    ...
    // Act
    Result<DFUWriteResponse> result = dfuWriteCommand.responseErrorCheck(response.toByteArray());
    // Assert

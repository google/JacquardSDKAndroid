...
public abstract class JacquardError extends Exception {
  ...
  public String getMessage() {
    switch (getType()) {
      case BLUETOOTH_CONNECTION_ERROR:
        return bluetoothConnectionError().getMessage();
      case BLUETOOTH_NOTIFICATION_UPDATE_ERROR:
        return bluetoothNotificationUpdateError().getMessage();
      case JACQUARD_INITIALIZATION_ERROR:
        return jacquardInitializationError().getMessage();
    }

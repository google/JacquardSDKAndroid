...
public abstract class DFUInfo {
  ...
  public static DFUInfo create(String version,
      ...
      String productId,
      String moduleId) {
    return create(version,dfuStatus,downloadUrl,vendorId,productId,moduleId,null);
  }
  ...
  public static DFUInfo create(String version,
    ...
    return new AutoValue_DFUInfo(
        Revision.fromZeroString(version),
        getUpgradeStatus(dfuStatus),
        downloadUrl,
        vendorId,
        productId,
        moduleId,

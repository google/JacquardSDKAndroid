 ...
 */
public class LoadModuleNotificationSubscription implements
    NotificationSubscription<Module> {

  InnerLoadModuleNotificationSubscription subscription = new InnerLoadModuleNotificationSubscription();

  @Nullable
  @Override
  public Module extract(Notification notification) {
    return subscription.extract(notification);
  }
}

...
interface CacheRepository {
   ...
   */
  Signal<String> cacheDescriptor(DFUInfo dfuInfo, FileDescriptor descriptor);
  ...
  void cacheUpdateInformation(DFUInfo dfuInfo, String vid, String pid, String mid,
      String currentVersion, long timeInMilliseconds);
   ...
   */
  default String imageInfoKey(String vid, String pid, String mid, String currentVersion) {
    String separator = "_";
    StringBuilder builder = new StringBuilder();

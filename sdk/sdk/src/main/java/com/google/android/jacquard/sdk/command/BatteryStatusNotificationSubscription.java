 ...
 */
public class BatteryStatusNotificationSubscription implements
  NotificationSubscription<BatteryStatus> {

 private final InnerBatteryStatusNotificationSubscription notificationSubscription =
  new InnerBatteryStatusNotificationSubscription();

  @Nullable
  @Override
  public BatteryStatus extract(Notification notification) {

...
abstract class FirmwareImageWriterState {
  ...
  static FirmwareImageWriterState ofCancel() {
    return AutoOneOf_FirmwareImageWriterState.cancel();
  }
  ...
  boolean isTerminal() {
    return getType() == Type.COMPLETE || getType() == Type.ERROR || getType() == Type.CANCEL;
  }

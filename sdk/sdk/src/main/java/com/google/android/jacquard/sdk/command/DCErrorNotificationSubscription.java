 ...
 */
public class DCErrorNotificationSubscription implements
    NotificationSubscription<DataCollectionStatus> {
  ...
  @Nullable
  @Override
  public DataCollectionStatus extract(Notification notification) {

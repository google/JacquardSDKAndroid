 ...
 */
class InnerImuSessionListNotificationSubscription extends
    InnerNotification<DataCollectionTrialListNotification, DataCollectionTrialListNotification> {

  @Override
  GeneratedExtension<Notification, DataCollectionTrialListNotification> getExtensionType() {
    return DataCollectionTrialListNotification.trialList;
  }

  @Nullable
  @Override
  DataCollectionTrialListNotification getNotification(

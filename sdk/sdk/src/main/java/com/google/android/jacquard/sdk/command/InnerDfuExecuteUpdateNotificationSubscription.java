 ...
 */
public class InnerDfuExecuteUpdateNotificationSubscription extends
    InnerNotification<DFUExecuteUpdateNotification, DFUExecuteUpdateNotification> {

  @Override
  public GeneratedExtension<Notification, DFUExecuteUpdateNotification> getExtensionType() {
    return DFUExecuteUpdateNotification.dfuExecuteUdpateNotif;
  }

  @Nullable
  @Override
  DFUExecuteUpdateNotification getNotification(

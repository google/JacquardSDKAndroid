 ...
 */
public class DfuExecuteUpdateNotificationSubscription
    implements NotificationSubscription<DFUExecuteUpdateNotification> {
  ...
  @Nullable
  @Override
  public DFUExecuteUpdateNotification extract(byte[] packet) {

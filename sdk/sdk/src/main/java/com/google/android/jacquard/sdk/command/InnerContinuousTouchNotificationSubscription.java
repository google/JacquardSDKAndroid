 ...
 * <p>
 *  When a the gear is touch {@link TouchData} will be emitted from
 * {@link com.google.android.jacquard.sdk.tag.ConnectedJacquardTag#subscribe(NotificationSubscription)}
 */
public class InnerContinuousTouchNotificationSubscription extends
  InnerNotification<TouchData, DataChannelNotification> {
  ...
  @Override
  public TouchData getNotification(DataChannelNotification dataChannelNotification) {

...
public abstract class ImuStream {
  ...
  public abstract DataCollectionMetadata metadata();

  public abstract String userId();

  public static ImuStream of(
      ImuSample sample,
      ImuConfiguration config,
      Sensors sensor,
      DataCollectionMetadata metadata,
      String userId) {
    return new AutoValue_ImuStream(sample, config, sensor, metadata, userId);
  }
}

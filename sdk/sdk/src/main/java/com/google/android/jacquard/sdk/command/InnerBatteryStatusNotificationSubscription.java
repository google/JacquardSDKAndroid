 ...
 *
 * <p>The tag will send a notification when the battery status changes and will be emitted from
 * {@link
 * com.google.android.jacquard.sdk.tag.ConnectedJacquardTag#subscribe(NotificationSubscription)}
 */
public class InnerBatteryStatusNotificationSubscription
    extends InnerNotification<BatteryStatus, BatteryStatusNotification> {

  @Override
  protected GeneratedExtension<Notification, BatteryStatusNotification> getExtensionType() {
    return BatteryStatusNotification.batteryStatusNotification;
  }

  @Override
  protected BatteryStatus getNotification(BatteryStatusNotification batteryStatusNotification) {

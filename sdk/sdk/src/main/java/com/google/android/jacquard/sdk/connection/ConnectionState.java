...
public abstract class ConnectionState implements Serializable {
  ...
  public static ConnectionState ofFirmwareUpdateInitiated() {
    return AutoOneOf_ConnectionState.firmwareUpdateInitiated();
  }

  public static ConnectionState ofFirmwareTransferring(int progress) {
    return AutoOneOf_ConnectionState.firmwareTransferring(progress);
  }

  public static ConnectionState ofFirmwareExecuting() {
    return AutoOneOf_ConnectionState.firmwareExecuting();
  }

  public static ConnectionState ofFirmwareTransferComplete(){
    return AutoOneOf_ConnectionState.firmwareTransferComplete();
  }
}

 ...
 */
public class ImuSessionListNotification implements
    NotificationSubscription<DataCollectionTrialListNotification> {
  ...
  @Nullable
  @Override
  public DataCollectionTrialListNotification extract(Notification notification) {

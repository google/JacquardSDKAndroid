...
class InnerLoadModuleNotificationSubscription
    extends InnerNotification<Module, LoadModuleNotification> {

  @Override
  protected GeneratedExtension<Notification, LoadModuleNotification> getExtensionType() {
    return LoadModuleNotification.loadModuleNotif;
  }

  @Nullable
  @Override
  protected Module getNotification(LoadModuleNotification loadModuleNotification) {

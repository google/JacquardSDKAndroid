 ...
 *
 * <p>When a gesture is performed on the gear a {@link Gesture} will be emitted from {@link
 * com.google.android.jacquard.sdk.tag.ConnectedJacquardTag#subscribe(NotificationSubscription)}
 */
public class GestureNotificationSubscription
    implements NotificationSubscription<Gesture> {

  private final InnerGestureNotificationSubscription notificationSubscription =
  new InnerGestureNotificationSubscription();

  @Nullable
  @Override
  public Gesture extract(byte[] packet) {

...
public class BeginCommand extends ProtoCommandRequest<JacquardProtocol.Response> {
  ...
  public JacquardProtocol.Request getRequest() {
    JacquardProtocol.BeginRequest beginRequest =
        JacquardProtocol.BeginRequest.newBuilder()
            .setProtocol(ProtocolSpec.VERSION_2.getProtocolId())
            .build();
    return JacquardProtocol.Request.newBuilder()
        .setId(getId())
        .setOpcode(JacquardProtocol.Opcode.BEGIN)
        .setDomain(JacquardProtocol.Domain.BASE)
        .setExtension(JacquardProtocol.BeginRequest.begin, beginRequest)
        .build();
  }
}
